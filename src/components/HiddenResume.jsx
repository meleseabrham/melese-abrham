        ...
        <div className="resume-two-column">
          ...
          <div className="resume-left-column">
            <div className="profile-image">
              <img src="/assets/project/profile.png" alt="Melese Abrham" />
            </div>
          ...
          <div className="resume-right-column">
            ...
            <div className="resume-section">
              ...
              <div className="resume-section">
                ...
                <ul className="resume-list">
                  ...
                  <li className="resume-list-item">
                    <strong>Responsibility:</strong> Software Application Development & Reverse Engineering
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="resume-section">
              ...
              <div className="skills-category">
                ...
                <ul className="resume-bullet-list">
  <li className="resume-bullet-item">
    Web & Mobile Development: HTML, CSS, JS, PHP, Java and Flutter
  </li>
  <li className="resume-bullet-item">
